...
export function EnclosureDialog({
  ...
  open,
  onOpenChange,
}: {enclosure: Enclosure, common_name: string, scientific_name: string, open: boolean, onOpenChange: (open: boolean)=>void}) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[540px] max-h-[85vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-xl">{enclosure.name} - {common_name}</DialogTitle>
          <small><i>{scientific_name}</i></small>
